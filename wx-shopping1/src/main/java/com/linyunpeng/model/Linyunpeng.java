 ...
 * @since 2019-01-06
 */
public class Linyunpeng extends Model<Linyunpeng> {
    ...
    public String toString() {
        ...
        ", cropPrice=" + cropPrice +
        ", cropKucun=" + cropKucun +
        ", cropYunfei=" + cropYunfei +
        ", cropFahuodi=" + cropFahuodi +
        ", cropUsername=" + cropUsername +
        ", cropDescribe=" + cropDescribe +
        ", imaAdd1=" + imaAdd1 +
        ", imaAdd2=" + imaAdd2 +
        ", imaAdd3=" + imaAdd3 +
        ", imaTouxiang=" + imaTouxiang +
        "}";
    }
}
